  ...
  return (
    <section className=" bg-black  ">
      <div className=" text-white font-poppins container mx-auto px-5 md:px-5 lg:px-10 py-24 md:py-32">
        ...
        <p className="mb-4">
          Xponent Funds website is owned by Xponent Funds, which is a data
          controller of your personal data.
        </p>

        <p className="mb-4">
          We have adopted this Privacy Policy, which determines how we are
          processing the information collected by Xponent Funds, which also
          provides the reasons why we must collect certain personal data about
          you. Therefore, you must read this Privacy Policy before using Xponent
          Funds website.
        </p>
        ...
        <p className="mb-4">
          When you visit the Xponent Funds, we automatically collect certain
        ...
        <p className="mb-4">
          ...
          contact us via{" "}
          <a href="mailto:help@xponentfunds.com" className="text-blue-400">
        ...
        <h2 className="text-2xl font-bold mb-2">Information security:</h2>
        ...
        <h2 className="text-2xl font-bold mb-2">Legal disclosure:</h2>
