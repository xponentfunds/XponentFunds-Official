    ...
    <section className=" bg-black ">
      <div className=" text-white font-poppins container mx-auto px-5 md:px-5 py-24 md:py-32">
        ...
        <p className="mb-4">
          ...
          use of Xponent Funds's Website, located at{" "}
          <a href="https://www.xponentfunds.in" className="text-blue-400">
            https://www.xponentfunds.in
          </a>
        </p>

        <p className="mb-4">
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use Xponent Funds if you do not agree
        ...
        <p className="mb-4">
          We use cookies to personalize your online experience. By accessing
          Xponent Funds, you agree to the use of cookies.
        </p>

        <p className="mb-4">
          Cookies are text files placed on your hard disk by a web page server.
          They cannot run programs or deliver viruses to your computer. Cookies
          are uniquely assigned to you and can only be read by a web server in
          the domain that issued the cookie to you.
        </p>

        <p className="mb-4">
          We use cookies to collect, store, and track information for
          statistical or marketing purposes to operate our website. You have the
          ability to accept or decline optional cookies. Some required cookies
          are necessary for the operation of our website and do not require your
          consent.
        </p>
        ...
        <p className="mb-4">
          Unless otherwise stated, Xponent Funds and/or its licensors own the
          intellectual property rights for all material on Xponent Funds. All
          intellectual property rights are reserved. You may access this from
          Xponent Funds for your own personal use subjected to restrictions set
          in these terms and conditions.
        </p>

        <ul className="list-disc list-inside mb-4">
          <li>Copy or republish material from Xponent Funds</li>
          <li>Sell, rent, or sub-license material from Xponent Funds</li>
          <li>Reproduce, duplicate or copy material from Xponent Funds</li>
          <li>Redistribute content from Xponent Funds</li>
        </ul>
        ...
        <p className="mb-4">
          ...
          opinions and information in certain areas. Xponent Funds does not
          filter, edit, publish, or review comments before their presence on the
          website. Comments reflect the views and opinions of the person who
          posts them and not the views of Xponent Funds.
        </p>

        <p className="mb-4">
          Xponent Funds reserves the right to monitor all comments and remove
          any comments that can be considered inappropriate, offensive, or cause
        ...
        <p className="mb-4">
          You hereby grant Xponent Funds a non-exclusive license to use,
        ...
        <p className="mb-4">
          ...
          the hyperlink compensates the absence of Xponent Funds; and (d) the
        ...
        <p className="mb-4">
          ...
          Xponent Funds. Please include your name, your organization name,
          ...
          URLs on our site to which you would like to link. Please wait 2-3
        ...
        <p className="mb-4">
          No use of Xponent Funds's logo or other artwork will be allowed for
