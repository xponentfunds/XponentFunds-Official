...
const Success = () => {
  ...
  return (
    <section className="bg-[#201E1E] px-5 md:px-0 py-16 md:py-36">
        ...
        {authorized ? (
          <div className="flex flex-col gap-2 md:gap-5 lg:gap-8 text-white justify-center items-center text-center">
            ...
            <p className="font-poppins text-sm md:text-base lg:text-lg">
              ...
              all your doubts and equipping you with the skills to join the top
              1% of successful traders.
              <br />
              To kickstart this journey, please join our exclusive WhatsApp
              group. We'll be sharing the webinar access link there, along with
              regular updates, valuable tips, and continuous support. Don't miss
              out on this opportunity to connect and grow with like-minded
              individuals!
            </p>
            <div className="flex flex-col gap-2 md:gap-5">
              ...
              <a
                href="https://chat.whatsapp.com/HxS5BzZiBytKLrFb0S3vyv"
              ...
              <p className="font-poppins text-sm md:text-base lg:text-lg">
                Note: The webinar access link will be provided exclusively in
                this group. Ensure you join to stay updated and not miss any
            ...
            <div className="flex flex-col gap-2 md:gap-5">
              ...
              <p className="font-poppins text-sm md:text-base lg:text-lg">
                ...
                out to us at *011 6929 0876*. We're here to help you every step
                of the way.
              </p>
            </div>
            <h4 className="font-poppins font-semibold text-xl">
              We're thrilled to have you on board. Let's work together to
              achieve trading excellence and financial success!
            </h4>
          </div>
        ) : (
          <div className="flex justify-center items-center ">
            <h1 className=" font-poppins font-medium text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-white">
              Unauthorized Access
            </h1>
          </div>
        )}
